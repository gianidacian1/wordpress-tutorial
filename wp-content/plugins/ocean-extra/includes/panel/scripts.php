...
class Ocean_Extra_Scripts_Panel {
	...
	public static function generate_js() {
		...
		if ( ! $customSelect
			...
			// Load lightbox js
			if ( $lightbox ) {
				$aFiles[] = $tDir .'third/magnific-popup.js';
				$aFiles[] = $tDir .'third/lightbox.js';
			}
			...
			if ( OCEANWP_WOOCOMMERCE_ACTIVE ) {
		    	...
		    	// Load wooMenuCart js
		    	if ( $wooMenuCart ) {
					$aFiles[] = $tDir .'third/woo/devs/wooMenuCart.js';
				}

		    	// Load wooCategoriesWidget js
		    	if ( $wooCategoriesWidget ) {
					$aFiles[] = $tDir .'third/woo/devs/wooCategoriesWidget.js';
				}
	...
	public static function generate_css() {
		...
		if ( ! $customSelect
		    ...
		    // Load lightbox
			if ( $lightbox ) {
				$aFiles[] = $tDir .'plugins/_magnific-popup.scss';
			}
