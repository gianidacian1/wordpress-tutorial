	...
	class Ocean_Extra_Contact_Info_Widget extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<div class="oceanwp-infos">
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('web') ); ?>"><?php esc_html_e('URL (with HTTP)', 'ocean-extra'); ?></label>
...
// Widget Styles
function ocean_extra_contact_info_widget_style() {
	global $pagenow;
	if ( is_admin() && $pagenow == "widgets.php" ) {
		add_action( 'admin_head', 'ocean_extra_contact_infos_style' );
		function ocean_extra_contact_infos_style() { ?>
			<style>
...
add_action( 'admin_init', 'ocean_extra_contact_info_widget_style' );