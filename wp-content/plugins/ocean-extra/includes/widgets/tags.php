...
if ( ! class_exists( 'Ocean_Extra_Tags_Widget' ) ) {
	class Ocean_Extra_Tags_Widget extends WP_Widget {
		...
		public function update( $new_instance, $old_instance ) {
			...
			$instance['bg_hover_color']  		= strip_tags( $new_instance['bg_hover_color'] );
			$instance['link_color']    			= strip_tags( $new_instance['link_color'] );
			$instance['link_hover_color']  		= strip_tags( $new_instance['link_hover_color'] );
			$instance['border_color']    		= strip_tags( $new_instance['border_color'] );
			$instance['border_hover_color']  	= strip_tags( $new_instance['border_hover_color'] );
		...
		public function form( $instance ) {
			...
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'bg_color' ) ); ?>" value="<?php echo esc_attr( $instance['bg_color'] ); ?>" />
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'bg_hover_color' ) ); ?>"><?php esc_html_e( 'Background Hover Color:', 'ocean-extra' ); ?></label>
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'bg_hover_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'bg_hover_color' ) ); ?>" value="<?php echo esc_attr( $instance['bg_hover_color'] ); ?>" />
			</p>
			...
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'link_hover_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'link_hover_color' ) ); ?>" value="<?php echo esc_attr( $instance['link_hover_color'] ); ?>" />
			</p>
			...
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'border_hover_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'border_hover_color' ) ); ?>" value="<?php echo esc_attr( $instance['border_hover_color'] ); ?>" />
			</p>
