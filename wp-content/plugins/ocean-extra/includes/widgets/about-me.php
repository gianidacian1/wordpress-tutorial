...
// Widget Styles
if ( ! function_exists( 'ocean_extra_about_me_widget_style' ) ) {
	function ocean_extra_about_me_widget_style() { ?>
		<style>
...
function ocean_extra_about_me_widget_scripts() {
	global $pagenow;
	if ( is_admin() && $pagenow == "widgets.php" ) {
		add_action( 'admin_head', 'ocean_extra_about_me_widget_style' );
		add_action( 'admin_footer', 'add_new_ocean_extra_about_me_ajax_trigger' );
		function add_new_ocean_extra_about_me_ajax_trigger() { ?>
			<script type="text/javascript" >
...
add_action( 'admin_init', 'ocean_extra_about_me_widget_scripts' );