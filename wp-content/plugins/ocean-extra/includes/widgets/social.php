...
// Widget Styles
if ( ! function_exists( 'ocean_extra_social_widget_style' ) ) {
	function ocean_extra_social_widget_style() { ?>
		<style>
...
function ocean_extra_social_widget_scripts() {
	global $pagenow;
	if ( is_admin() && $pagenow == "widgets.php" ) {
		add_action( 'admin_head', 'ocean_extra_social_widget_style' );
		add_action( 'admin_footer', 'add_new_ocean_extra_social_ajax_trigger' );
		function add_new_ocean_extra_social_ajax_trigger() { ?>
...
add_action( 'admin_init', 'ocean_extra_social_widget_scripts' );